...
from workout_api.atleta.schemas import AtletaIn, AtletaOut, AtletaListOut, AtletaUpdate
...
async def query(
    ...
    query = select(AtletaModel).offset(offset).limit(limit)
